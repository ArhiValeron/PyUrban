...
def send_email(message, recipient, sender="university.help@gmail.com"):
    ...
    for i in recipient:
        if i == "@":
            k_sobak += 1
    if (k_sobak != 1 or len(recipient) < 8 or
            (".com" not in recipient and ".ru" not in recipient and ".net" not in recipient)):
...
send_email('Напоминаю самому себе о вебинаре', 'urban.teachermail.ru', sender='urban.teacher@mail.ru')
